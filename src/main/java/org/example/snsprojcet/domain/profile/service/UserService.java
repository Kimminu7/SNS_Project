...
public class UserService {
    ...
    public UserResponseDto findById(Long profile) {


        User findUser = userRepository.findById(profile).orElseThrow(
                () -> new ResponseStatusException(HttpStatus.NOT_FOUND, "유저 프로필을 조회할 수 없습니다. :" + profile)
        );
