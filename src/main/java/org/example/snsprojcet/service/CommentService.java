package org.example.snsprojcet.service;

import lombok.RequiredArgsConstructor;
import org.example.snsprojcet.dto.CommentRequestDto;
import org.example.snsprojcet.dto.CommentResponseDto;
import org.example.snsprojcet.entity.Board;
import org.example.snsprojcet.entity.Comment;
import org.example.snsprojcet.entity.User;
import org.example.snsprojcet.repository.CommentRepository;
...
public class CommentService {
    ...
    public CommentResponseDto save(Long boardId, Long userId, String content) {
        ...
        // 보드, 유저 id 조회
        Board board = boardRepository.findByIdOrElseThorw(boardId);
        User user = userRepository.findByIdOrElseThorw(userId);
        // 댓글 생성
    ...
    public List<CommentResponseDto> findAll() {
        return commentRepository.findAll().stream().map(CommentRequestDto :: toDto).toList();
    }
